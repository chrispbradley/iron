                ...
                IF(ASSOCIATED(MESH)) THEN
                  ...
                  IF(ASSOCIATED(GENERATED_MESH)) THEN
                    ...
                    IF(ASSOCIATED(NODES_MAPPING)) THEN
                      ...
                      CALL GeneratedMeshSurfaceGet(GENERATED_MESH,MESH_COMPONENT,1_INTG, &
                          & INNER_SURFACE_NODES,INNER_NORMAL_XI,ERR,ERROR,*999) !Inner
                      CALL GeneratedMeshSurfaceGet(GENERATED_MESH,MESH_COMPONENT,2_INTG, &
                          & OUTER_SURFACE_NODES,OUTER_NORMAL_XI,ERR,ERROR,*999) !Outer
                      CALL GeneratedMeshSurfaceGet(GENERATED_MESH,MESH_COMPONENT,3_INTG, &
                          & TOP_SURFACE_NODES,TOP_NORMAL_XI,ERR,ERROR,*999) !Top
                      CALL GeneratedMeshSurfaceGet(GENERATED_MESH,MESH_COMPONENT,4_INTG, &
