...
!   TYPE(LINKEDLIST),POINTER :: LIST(:) !< \todo Comment
  ...
  TYPE DOMAIN_MAPPING_TYPE
    ...
    INTEGER(INTG), ALLOCATABLE :: NUMBER_OF_DOMAIN_BOUNDARY(:) !<NUMBER_OF_DOMAIN_BOUNDARY(domain_no). The number of boundary values for domain_no'th domain. NOTE: the domain_no goes from 0 to the number of domains-1.
